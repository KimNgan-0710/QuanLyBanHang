...
namespace BTL_XDCTQuanLyBanHang
{
    public partial class frmKhachHang : Form
    {
        ...
        private void dgvKhachHang_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            txtMaK.Text = dgvKhachHang.CurrentRow.Cells["MaK"].Value.ToString();
            txtTenK.Text = dgvKhachHang.CurrentRow.Cells["TenK"].Value.ToString();
        ...
        {
            string sql;
            if (txtMaK.Text.Trim().Length == 0)
            {
                MessageBox.Show("Bạn phải nhập mã khách", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Information);
                txtMaK.Focus();
                return;
            }
            if (txtTenK.Text.Trim().Length == 0)
            {
            ...
            sql = "SELECT MaK FROM tblKhachHang WHERE MaK=N'" + txtMaK.Text.Trim() + "'";
            ...
            //Chèn thêm
            sql = "INSERT INTO tblKhachHang VALUES (N'" + txtMaK.Text.Trim() +
                "',N'" + txtTenK.Text.Trim() + "',N'" + txtDiaChi.Text.Trim() + "','" + mtbSdt.Text + "')";
        ...
        private void btnSua_Click(object sender, EventArgs e)
        {
            ...
            sql = "UPDATE tblKhachHang SET TenK=N'" + txtTenK.Text.Trim().ToString() + "',DiaChi=N'" +
                txtDiaChi.Text.Trim().ToString() + "',DienThoai='" + mtbSdt.Text.ToString() +
                "' WHERE MaK=N'" + txtMaK.Text + "'";
            Functions.RunSQL(sql);
            LoadDataGridView();
            ResetValues();
            btnBoQua.Enabled = false;
        ...
        private void btnXoa_Click(object sender, EventArgs e)
        {
            ...
            {
                sql = "DELETE tblKhachHang WHERE MaK=N'" + txtMaK.Text + "'";
                Functions.RunSQL(sql);
                LoadDataGridView();
                ResetValues();
            }
